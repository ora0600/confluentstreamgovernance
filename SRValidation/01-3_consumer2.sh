...
kafka-avro-console-consumer --bootstrap-server $CCLOUD_CLUSTERID1_BOOTSTRAP --topic webinar --group validavroconsumer2 --consumer.config ../ccloud_user1.properties \
 --from-beginning \
